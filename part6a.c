/*
Question 6a of OS Homework 5 by Chris Lee

This program implements the maximized throughput
...
void wait_until_safe_to_cross(DESTINATION d) {
    ...
    case WEST:
        ...
        if ((direction == -1 || direction == 0) && monkeys_on_rope < 5) {
            direction = -1;
            monkeys_on_rope++;
